...
At the latest checkpoint the original side had 88 responses from 102 dispatched
requests and FortBO had 166 responses from 177; both child runners and the
