...
`/var/tmp/ert`. At the 19:11 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:51:12, with evaluator processes
active. The oracle scratch root had 137 dispatched requests and 120 response
files; the FortBO root had 141 requests and 101 responses, with the pair ledger
