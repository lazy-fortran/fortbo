...
At the latest checkpoint the original side had 60 responses from 74 dispatched
requests and FortBO had 96 responses from 107; both child runners and the
