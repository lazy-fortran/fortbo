...
`/var/tmp/ert`. At the 19:29 CEST checkpoint, the parent and both child
evaluator processes were still alive after 02:08:45, with evaluator processes
active. The oracle scratch root had 147 dispatched requests and 132 response
files; the FortBO root had 162 requests and 120 responses, with the pair ledger
