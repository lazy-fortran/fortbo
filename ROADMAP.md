...
At the latest checkpoint the original side had 82 responses from 96 dispatched
requests and FortBO had 153 responses from 164; both child runners and the
