...
`/var/tmp/ert`. At the 19:06 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:45:42, with evaluator processes
active. The oracle scratch root had 132 dispatched requests and 116 response
files; the FortBO root had 137 requests and 98 responses, with the pair ledger
