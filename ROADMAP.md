...
At the latest checkpoint the original side had 69 responses from 83 dispatched
requests and FortBO had 118 responses from 129; both child runners and the
