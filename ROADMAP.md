...
`/var/tmp/ert`. At the 19:04 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:43:43, with evaluator processes
active. The oracle scratch root had 130 dispatched requests and 113 response
files; the FortBO root had 134 requests and 95 responses, with the pair ledger
