...
At the latest checkpoint the original side had 71 responses from 85 dispatched
requests and FortBO had 124 responses from 134; both child runners and the
