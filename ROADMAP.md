...
At the latest checkpoint the original side had 64 responses from 78 dispatched
requests and FortBO had 106 responses from 117; both child runners and the
