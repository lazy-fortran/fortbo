...
At the latest checkpoint the original side had 74 responses from 86 dispatched
requests and FortBO had 130 responses from 141; both child runners and the
