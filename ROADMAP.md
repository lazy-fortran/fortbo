...
`/var/tmp/ert`. At the 19:16 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:56:08, with evaluator processes
active. The oracle scratch root had 140 dispatched requests and 125 response
files; the FortBO root had 147 requests and 106 responses, with the pair ledger
