...
`/var/tmp/ert`. At the 19:27 CEST checkpoint, the parent and both child
evaluator processes were still alive after 02:06:49, with evaluator processes
active. The oracle scratch root had 145 dispatched requests and 131 response
files; the FortBO root had 159 requests and 117 responses, with the pair ledger
