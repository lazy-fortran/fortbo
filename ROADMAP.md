...
`/var/tmp/ert`. At the 19:12 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:51:53, with evaluator processes
active. The oracle scratch root had 137 dispatched requests and 121 response
files; the FortBO root had 142 requests and 102 responses, with the pair ledger
