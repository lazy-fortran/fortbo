...
`/var/tmp/ert`. At the 19:15 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:54:41, with evaluator processes
active. The oracle scratch root had 139 dispatched requests and 125 response
files; the FortBO root had 145 requests and 104 responses, with the pair ledger
