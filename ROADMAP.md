...
At the latest checkpoint the original side had 97 responses from 111 dispatched
requests and FortBO had 190 responses from 201; both child runners and the
