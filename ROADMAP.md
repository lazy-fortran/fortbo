...
`/var/tmp/ert`. At the 19:05 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:44:17, with evaluator processes
active. The oracle scratch root had 132 dispatched requests and 115 response
files; the FortBO root had 136 requests and 97 responses, with the pair ledger
