...
`/var/tmp/ert`. At the 19:19 CEST checkpoint, the parent and both child
evaluator processes were still alive after 01:58:57, with evaluator processes
active. The oracle scratch root had 141 dispatched requests and 126 response
files; the FortBO root had 151 requests and 110 responses, with the pair ledger
