...
At the latest checkpoint the original side had 83 responses from 97 dispatched
requests and FortBO had 160 responses from 170; both child runners and the
