...
At the latest checkpoint the original side had 96 responses from 110 dispatched
requests and FortBO had 186 responses from 197; both child runners and the
